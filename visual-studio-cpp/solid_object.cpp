...
{
	POINT origan_points[4];
	_points_symmetric(origan_points);
	//_center[0] ,_center[1] //int [2]
	...
	//_angle, _half_length, _half_width

	//ACL_Color getPixel(int x, int y) ==BLACK ==WHITE ==GREY
